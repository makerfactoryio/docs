...
To convert the 5V from to the 3.3V that most of the sub-circuits need, the board uses the [NCP6324B](http://www.onsemi.com/pub/Collateral/NCP6324-D.PDF) from *On-Semiconductor* (U2).
